...
- [ ] **1.1 Add SpaceID to SOPTemplate**
...
- [ ] **1.2 Rename SOPTemplateVersion → SOPVersion**
...
- [ ] **1.3 Add StationID and LinkedSOPTemplateID to SOPStep**
...
- [ ] **1.5 Update SOPStepMedia to support sub-step media**
...
- [ ] **3.5 Create TicketSubStep model**
...
- [ ] **4.1 Create ActivityEntry model**
...
- [ ] **5.3 Ticket step execution service**
...
- [ ] **5.4 Ticket creation from SOP service**
...
- [ ] **6.1 Default ticket types for shop spaces**
